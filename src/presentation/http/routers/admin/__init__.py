...
# TODO DEV: удалить импорты db_admin_router и dev_admin_router перед релизом.
...
# TODO DEV: удалить include_router(db_admin_router) перед релизом.
protected_admin_router.include_router(db_admin_router)
# TODO DEV: удалить include_router(dev_admin_router) перед релизом.
protected_admin_router.include_router(dev_admin_router)
